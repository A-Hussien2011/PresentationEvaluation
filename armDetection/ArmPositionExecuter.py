...
class ArmPositionExecuter:
    def __init__(self):
        self.protoFile = "/content/PresentationEvaluation/assets/bodyPose/pose_deploy_linevec.prototxt"
        self.weightsFile = "/content/PresentationEvaluation/assets/bodyPose/pose_iter_440000.caffemodel"
        self.nPoints = 18
